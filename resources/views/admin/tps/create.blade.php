...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Tambah TPS</h1>
            <p class="text-sm text-gray-500">Tambahkan data Tempat Penampungan Sementara baru.</p>
        </div>
        ...
        <form action="{{ route('admin.tps.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama_tps" value="{{ old('nama_tps') }}" placeholder="Contoh: TPS Pasar Baru" 
                ...
                <div>
                    ...
                    <input type="number" name="kapasitas" value="{{ old('kapasitas') }}" placeholder="Contoh: 750" 
                ...
                <div>
                    ...
                    <input type="text" name="latitude" value="{{ old('latitude') }}" placeholder="-2.561234" 
                ...
                <div>
                    ...
                    <input type="text" name="longitude" value="{{ old('longitude') }}" placeholder="140.718345" 
                        class="w-full border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="mt-6">
                ...
                <textarea name="alamat" rows="3" placeholder="Masukkan alamat lengkap TPS" 
                    class="w-full border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-blue-500 focus:border-blue-500">{{ old('alamat') }}</textarea>
