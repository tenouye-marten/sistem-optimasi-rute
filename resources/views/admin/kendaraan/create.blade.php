...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-sm text-gray-500">Tambahkan data kendaraan operasional baru ke dalam sistem.</p>
        </div>
        ...
        <form action="{{ route('admin.kendaraan.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" value="Otomatis dibuat oleh sistem" readonly 
                ...
                <div>
                    ...
                    <input type="text" name="nama_kendaraan" value="{{ old('nama_kendaraan') }}" placeholder="Contoh: Dump Truck Mitsubishi" 
                ...
                <div>
                    ...
                    <input type="text" name="nomor_polisi" value="{{ old('nomor_polisi') }}" placeholder="Contoh: PA 8001 JA" 
                ...
                <div>
                    ...
                    <input type="number" name="kapasitas" value="{{ old('kapasitas') }}" min="1" placeholder="Masukkan berat dalam Kg" 
                        class="w-full border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-blue-500 focus:border-blue-500" required>
            ...
            @if($drivers->isEmpty())
                <div class="mt-6 bg-yellow-50 border border-yellow-200 text-yellow-700 px-4 py-3 rounded-lg text-sm flex items-center gap-2">
                    <span>⚠️</span> Tidak ada driver tersedia untuk ditugaskan.
                </div>
            @endif
            ...
            <div class="mt-8 flex items-center justify-end gap-3">
                ...
                <button type="submit" {{ $drivers->isEmpty() ? 'disabled' : '' }} 
                    class="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white font-medium px-6 py-2.5 rounded-lg text-sm shadow-sm transition">
                    Simpan Kendaraan
                </button>
            </div>
        </form>
