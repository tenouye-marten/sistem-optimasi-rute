...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Rekapitulasi dan analisis seluruh kegiatan pengangkutan sampah.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        @foreach($stats as $stat)
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                <p class="text-xs text-gray-500 uppercase font-semibold">{{ $stat[0] }}</p>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('admin.laporan.print', request()->query()) }}" target="_blank" class="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition flex items-center">
        ...
        <table class="w-full text-sm text-left text-gray-600">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-4 py-3 font-medium">{{ number_format($p->muatan_sekarang) }} Kg</td>
                    <td class="px-4 py-3">
                        @php
