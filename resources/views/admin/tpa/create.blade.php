...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Tambah TPA</h1>
            <p class="text-sm text-gray-500">Tambahkan data Tempat Pemrosesan Akhir baru.</p>
        </div>
    ...
    <div class="bg-white shadow-sm border border-gray-100 rounded-xl p-6 md:p-8">
        <form action="{{ route('admin.tpa.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama_tpa" value="{{ old('nama_tpa') }}" placeholder="Contoh: TPA Regional" 
