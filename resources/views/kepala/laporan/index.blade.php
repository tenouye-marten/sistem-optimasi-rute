...
@section('title', 'Laporan Pengangkutan - Kepala Dinas')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('kepala.laporan.pdf', request()->query()) }}" target="_blank" class="bg-red-600 hover:bg-red-700 text-white font-medium text-sm px-4 py-2 rounded-lg transition">
                <i class="fas fa-file-pdf mr-1.5"></i> Export PDF
            </a>
            <a href="{{ route('kepala.laporan.print', request()->query()) }}" target="_blank" class="bg-green-600 hover:bg-green-700 text-white font-medium text-sm px-4 py-2 rounded-lg transition">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        <form method="GET" action="{{ route('kepala.laporan.index') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
            <div>
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('kepala.laporan.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-3 py-2 rounded-lg text-sm transition">
                    Reset
                </a>
            </div>
        </form>
