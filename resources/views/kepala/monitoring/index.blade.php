...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        @php
            $stats = [
                ['Hari Ini', $totalHariIni, 'text-gray-800'],
                ['Sedang Berjalan', $berjalan, 'text-blue-600'],
                ['Selesai', $selesai, 'text-green-600'],
                ['Belum Berangkat', $belum, 'text-red-600'],
            ];
        @endphp
        ...
        <table class="w-full text-sm text-left text-gray-600">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 border-b border-gray-100">
                <tr>
                    ...
                    <th class="px-4 py-3.5">Muatan</th>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-4 py-3">
                        ...
                        <span class="text-gray-400">/ {{ number_format($item->kapasitas_kendaraan) }} Kg</span>
                    </td>
                    <td class="px-4 py-3">
                        @php
                            $colors = [
                ...
                @empty
                <tr>
                    <td colspan="8" class="px-4 py-10 text-center text-gray-400 bg-gray-50/50">Belum ada data monitoring.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
