...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Informasi detail proses pengangkutan sampah.</p>
        </div>
        <a href="{{ route('kepala.monitoring.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium px-4 py-2 rounded-lg text-sm transition">
            Kembali
        </a>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100">
            <h2 class="font-bold text-gray-800">Detail Pengangkutan TPS</h2>
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-600">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-3">{{ number_format($detail->volume_diangkut) }} Kg</td>
                        <td class="px-6 py-3">
                            @php
                                $statusColors = [
    ...
    {{-- Keterangan Driver --}}
    @if($pengangkutan->keterangan)
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h3 class="font-bold text-gray-800 mb-3">Keterangan Driver</h3>
