...
<ul class="space-y-1 text-sm">
    ...
    {{-- Driver --}}
    <li class="mt-6">
        <p class="px-4 mb-2 text-xs font-bold uppercase tracking-wider text-gray-400">Driver</p>
    </li>
    ...
    <li>
        <a href="{{ route('driver.rute.index') }}"
            ...
            <span class="ml-3">Rute Saya</span>
        </a>
    </li>
    ...
    @if($pengangkutanAktif)
        <li>
            <a href="{{ route('driver.pengangkutan.index') }}"
                ...
                <span class="ml-3">Pengangkutan</span>
            </a>
        </li>
        <li>
            <a href="{{ route('driver.pengangkutan.tps') }}"
                ...
                <span class="ml-3">TPS Aktif</span>
            </a>
        </li>
    @endif
    ...
    {{-- Akun --}}
    <li class="mt-6">
        <p class="px-4 mb-2 text-xs font-bold uppercase tracking-wider text-gray-400">Akun</p>
    </li>
    <li>
